...
$upload_dir = '/mac/images/uploads/'; 

// HERE PERMISSIONS FOR IMAGE
$imgsets = array(
 'maxsize' => 7000,          // maximum file size, in KiloBytes (2 MB)
 'maxwidth' => 7000,          // maximum allowed width, in pixels
 'maxheight' => 7000,         // maximum allowed height, in pixels
...
if(isset($_FILES['upload']) && strlen($_FILES['upload']['name']) > 1) {
  ...
  $img_name = date("jnYGis")."-".basename($_FILES['upload']['name']);
